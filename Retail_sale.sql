...
-- How any unique customers do we have?
SELECT COUNT(DISTINCT customer_id ) AS total_customers FROM retail_sales;

-- How any unique categories do we have?
SELECT DISTINCT category  FROM retail_sales;

-- What re the various unique quantities?
SELECT DISTINCT quantity  FROM retail_sales;

-- DATA ANLYSIS AND BUSINESS KEY PROBLEMS & ANSWERS
...
SELECT
    ...
    COUNT(total_sale) AS category_orders
FROM retail_sales
GROUP BY category;
